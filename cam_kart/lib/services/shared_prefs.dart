...
class SharedPrefs{
  ...
  Future<bool> getTheme() async {
    return (await SharedPreferences.getInstance()).getBool('darkMode')??false;
  }
  ...
  Future<String?> getRestId()async{
    return (await SharedPreferences.getInstance()).getString('restID');
